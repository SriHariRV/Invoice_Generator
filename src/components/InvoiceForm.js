...
class InvoiceForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      dateOfIssue: '',
      billTo: '',
      billToCompany: '', // New state field for Bill To Company
      billToEmail: '',
      billToPhone: '',
      billToDesignation: '',
      billToAddress: '',
      billFrom: '',
      billFromCompany: '', // New state field for Bill From Company
      billFromEmail: '',
      billFromPhone: '',
      billFromDesignation: '',
      billFromAddress: '',
            ...
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              <Row className="mb-5">
                <Col>
                  ...
                  <Form.Control placeholder={"Company name"} value={this.state.billFromCompany} type="text" name="billFromCompany" className="my-2" onChange={(event) => this.editField(event)} autoComplete="organization" required="required" />
                  ...
                  <Form.Control placeholder={"Phone number"} value={this.state.billFromPhone} type="text" name="billFromPhone" className="my-2" onChange={(event) => this.editField(event)} autoComplete="tel" required="required" />
                  <Form.Control placeholder={"Designation"} value={this.state.billFromDesignation} type="text" name="billFromDesignation" className="my-2" onChange={(event) => this.editField(event)} autoComplete="organization-title" required="required" />
                ...
                <Col>
                  ...
                  <Form.Control placeholder={"Company name"} value={this.state.billToCompany} type="text" name="billToCompany" className="my-2" onChange={(event) => this.editField(event)} autoComplete="organization" required="required" />
                  ...
                  <Form.Control placeholder={"Phone number"} value={this.state.billToPhone} type="text" name="billToPhone" className="my-2" onChange={(event) => this.editField(event)} autoComplete="tel" required="required" />
                  <Form.Control placeholder={"Designation"} value={this.state.billToDesignation} type="text" name="billToDesignation" className="my-2" onChange={(event) => this.editField(event)} autoComplete="organization-title" required="required" />
              ...
              <Row className="mt-4 justify-content-end">
                <Col lg={6}>
                  ...
                  <div className="d-flex flex-row align-items-start justify-content-between mt-2">
                    ...
                    <span><span className="small ">({this.state.discountRate || 0}%)</span>{this.state.currency}{this.state.discountAmount || 0}</span>
                  </div>
                  <div className="d-flex flex-row align-items-start justify-content-between mt-2">
                    <span className="fw-bold">Tax:</span>
                    <span><span className="small ">({this.state.taxRate || 0}%)</span>{this.state.currency}{this.state.taxAmount || 0}</span>
                  </div>
                  <hr />
